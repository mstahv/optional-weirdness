...
UPDATE: I almost became a Maven contributor, but looks like this is already fixed in Maven 4. Checked out the sources to make a fix, but was no more able to reproduce with local build 😎 Also verified with 4.0.0-rc-5 (which I yesterday unsuccessully used when trying to reproduce...). 
